...
for epoch in range(10):
    ...
    for context, target in trigrams:
        ...
        #Step2. Recall that torch *accumulates* gradients.Before passing in a
        ...
        #Step5. DOthe backward pass and update the gradient
        loss.backward()
        optimizer.step()
...
context_idx = torch.tensor([word_to_ix[w] for w in (S1, S2)], dtype = torch.long)
result = ix_to_word[model(context_idx).data.topk[1]]
print(result)
